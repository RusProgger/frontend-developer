...
const translations = {
    uk: {
         ...
         'data-translate-about-desc': 'Вітаю. Мене звати Руслан я фронтенд-розробник, дизайнер та програміст. Навички: C/C++, ООП, стандартна бібліотека шаблонів (STL), багатопотокове програмування, узагальнене програмування, Python, Java, Go(Goland), базові знання PHP/Mysql, JavaScript. Знайомий з фреймворками Bootstrap 4/5, Tailwind CSS, MJML, SASS/SCSS, шаблонізатор Pug, адаптивна верстка, методологія БЕМ. Працюю з операційними системами windows/Linux.',
    ...
    en: {
         ...
         'data-translate-about': "About me",
         'data-translate-about-desc': 'Hello, my name is Ruslan. I am a Front-End Developer, Designer, and Programmer. Skills: C/C++, OOP (Object-Oriented Programming), Standard Template Library (STL), Multithreading, Template Programming, Python, Java, Go (Golang), Basic knowledge of PHP/MySQL, JavaScript, Familiar with frameworks: Bootstrap 4/5, Tailwind CSS, MJML, SASS/SCSS, Templating engine Pug, Responsive Web Design, BEM Methodology. Experience with Operating Systems: Windows/Linux',
